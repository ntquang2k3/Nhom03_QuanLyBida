...
namespace GUI
{
    public partial class frmQuanLyHoaDon2 : Form
    {
        private HoaDonBLL hoaDonBLL;
        private int selectedMaHDBH = -1;
        public frmQuanLyHoaDon2()
        {
            InitializeComponent(); 
        ...
        private void dateNgayChoi_ValueChanged_1(object sender, EventArgs e)
        {
            UpdateDataGridView();
        }

        private void cbBan_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            UpdateDataGridView();
        }

        private void cbDatcoc_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            UpdateDataGridView();
        }
